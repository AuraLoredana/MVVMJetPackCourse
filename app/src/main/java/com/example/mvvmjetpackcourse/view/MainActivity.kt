...
import com.example.mvvmjetpackcourse.util.PERMISSION_SEND_SMS_REQUEST_CODE
...
class MainActivity : AppCompatActivity() {
    ...
    private fun requestSmsPermission() {
        ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.SEND_SMS), PERMISSION_SEND_SMS_REQUEST_CODE)
    }
